...
- SIL Open font license + har et aktivt community
...
- Variabel font ([Les mer](https://fonts.google.com/knowledge/glossary/variable_fonts))
...
For hosting kan Altinns CDN benyttes:
